...
public class Payment extends HttpServlet
{
  ...
  String ACTION_Payment = "Payments";
  ...
  String FIELD_USER2 = "user2";
  String FIELD_USER3 = "user3";
  ...
  public void Confirm_Payment(java.io.PrintWriter out, HttpServletRequest req)
	...
	PreparedStatement ps = null;
		...
		String sql = "UPDATE application , course set paid = 'Y' where " +
			  ...
			  " and approve = 'Y' and confirm = 'Y' and paid = 'N'";
		ps = con.prepareStatement(sql);
  		...
  		if (count > 0) {
  			...
  			out.println("<tr>");
        		...
        		out.println("There are " + count + " record update by payment confirm.");
  		...
  		{	
  			...
  			out.println("<tr>");
    			out.println("<td width=290 bgcolor=#9B96D8><font face=Arial size=3 color=#FFFFFF>");
        		out.println("There are no record update by payment confirm.");
  	  		out.println("Please use left screen try other operation.");
  	  		out.println("</td>");
  	  		out.println("</tr>");
  	  		out.println("</table>");
  ...
  public void Refund(java.io.PrintWriter out, HttpServletRequest req, String uri)
    {
	String user = getParameter(req, FIELD_USER2);
	...
	Connection con = null;
		...
		con = DriverManager.getConnection(CONNECTION_URL);
   		...
   		String sql1 = "SELECT a.app_id , p.app_name , c.course_id , description" +
		" , cancelled , fee ,p.app_hkid from course c,application a, applicant p" +
		" where p.app_hkid=? and p.app_id = a.app_id and c.course_id = a.course_id" +
		...
		out.println("<body bgcolor=#FFFFFF topmargin=2 leftmargin=2>");
  		...
  		if (rs.next()) {
  			...
  			String APP_HK = rs.getString("app_hkid");
			...
			out.println("</table>");
  			...
  			out.println("<tr>");
    			...
    			out.println("<td width=54 bgcolor=#C0C0C0><font face=Arial color=#333333 size=1><b>Cancelled</b></font></td>");
  ...
  public void Payments(java.io.PrintWriter out, HttpServletRequest req, String uri)
    {
	...
	Connection con = null;
		...
		String sql = "SELECT p.app_name , p.app_hkid , c.course_id , description" +
		" , approve , confirm , fee , p.app_id from course c, application a, applicant p" +
		" where p.app_hkid=?  and p.app_id = a.app_id and c.course_id = a.course_id" +
		" and approve = 'Y' and confirm = 'Y' and paid = 'N'";
  		...
  		if (rs.next()) {
			...
			out.println("</table>");
  			...
  			out.println("<tr>");
    			...
    			out.println("<td width=54 bgcolor=#C0C0C0><font face=Arial color=#333333 size=1><b>Confirmed</b></font></td>");
    			out.println("<td width=54 bgcolor=#C0C0C0><font face=Arial color=#333333 size=1><b>Paid Amount</b></font></td></tr>");
      			out.println("<tr valign=top bgcolor =#F3F4F5>");
  			out.println("<td width=63><font size=1 face=Arial color=#333333>" +
  					APP_HK + "</font></td>");
	...
	PreparedStatement ps = null;
		...
		ps = con.prepareStatement(sql);
  		...
  		if (count > 0) {
  			...
  			out.println("<tr>");
    			out.println("<td width=290 bgcolor=#9B96D8><font face=Arial size=3 color=#FFFFFF>");
        		out.println("There are " + count + " record update by refund confirm.");
  	  		out.println("Please use left screen try other operation.");
  	  		out.println("</td>");
  	  		out.println("</tr>");
  	  		out.println("</table>");
  		...
  		{	
  			...
  			out.println("<tr>");
    			out.println("<td width=290 bgcolor=#9B96D8><font face=Arial size=3 color=#FFFFFF>");
        		out.println("There are no record update by refund confirm.");
  	  		out.println("Please use left screen try other operation.");
  	  		out.println("</td>");
  	  		out.println("</tr>");
  	  		out.println("</table>");
	...
	PreparedStatement ps = null;
		...
		ps = con.prepareStatement(sql);
  		...
  		if (count > 0) {
  			...
  			out.println("<tr>");
    			out.println("<td width=290 bgcolor=#9B96D8><font face=Arial size=3 color=#FFFFFF>");
        		out.println("There are " + count + " record update by Instructor confirm.");
  	  		out.println("Please use left screen try other operation.");
  	  		out.println("</td>");
  	  		out.println("</tr>");
  	  		out.println("</table>");
  		...
  		{	
  			...
  			out.println("<tr>");
    			out.println("<td width=290 bgcolor=#9B96D8><font face=Arial size=3 color=#FFFFFF>");
        		out.println("There are no record updated by Instructor Confirm.");
  	  		out.println("Please use left screen try other operation.");
  	  		out.println("</td>");
  	  		out.println("</tr>");
  	  		out.println("</table>");
  ...
  public void Instructor(java.io.PrintWriter out, HttpServletRequest req, String uri)
    {
	String user = getParameter(req, FIELD_USER3);
	...
	Connection con = null;
		...
		int total = 0;
  		...
  		if (rs.next()) {
			...
			out.println("<table border=0 width=722 cellspacing=1 cellpadding=1>");
  			out.println("<tr>");
    			out.println("<td colspan=3 height=20><b><font face=Arial size=4 color=#666666>Instructor Salary</font></b></td>");
  			out.println("</tr>");
			out.println("<tr>");
     			out.println("<td width=290 bgcolor=#9B96D8><font face=Arial size=1 color=#FFFFFF>");
       			out.println("<font face=Arial size=1 color=#FFFFFF>");
