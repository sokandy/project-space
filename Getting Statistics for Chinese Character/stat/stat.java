...
// The function of the program is Getting statistics for Chinese Characters.
// Read in a program parameter n, which will be used in the reporting/output of the program.
// For each Chinese Character C in the input file, collect its absolute frequency Freq(C).
// The program only want information on Chinese characters, punctuation marks should not count.
// For each Chinese bigram C1C2, collect the absolute frequency of Freq(C1C2)
// Calculate the conditional probability P(C2 | C1) and List the top n output
// for Freq(C1), Freq(C1C2) and P(C2| C1).
...
public class stat
{
  public static void main(String args[])
  {
    ...
    {
      // ************   1st step started    *************************
      // 1st step:  It will be read the plain text file into byte[] *
      // array and the integer for show n top output. If you enter  *
      // zero for no sorting output display.                        *
      // ************************************************************
      ...
      if (f.exists())
      {
        ...
        //  ***********   2nd step started    *************************
        //  2nd step: Clean the English letters and punctuation marks *
        //  from the byte[] array.                                    *
        //  ***********************************************************
        for (int n = 0; n < b.length; n++) {
          temp = ( (int) b[n] & 0xff);
          if (temp >= 161 && temp <= 254) {
        ...
        //  ***********   3rd step started  **************************
        // 3rd step: Convert large byte[] array into String[] array, *
        // which size is four characters (two bytes).And it will     *
        // count the frequency of single Chinese characters.         *
        // ***********************************************************
	...
	freq[ncounter]++;
        ...
        for (int n = 0; n < fileSize/2; n++)   // counting the freq. of two word
          freq2[n] = 0;
	...
	freq2[n2counter]++;
        ...
        //  ***********   4th step started  **************************
        //  Sorting the decreasing order of the frequency of the one *
        //  word and two words by Selection Sorting algorithms.      *
        //  **********************************************************
        if (sortflag == true)
        {
        ...
        //  ***********   5th step started  **************************
        //  Printing the one word and two words final result         *
        //  **********************************************************
        System.out.println();
        ...
        //  ***********   6th step started  ***************************
        //  6th step: Calculate the conditional probability P(C2 | C1)*
        //  by using the given formula and print the result.          *
        //  ***********************************************************
