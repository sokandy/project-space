  ...
  public static void main(String args[])
  {
    try
    {
      ...
      if (f.exists())
      {
        ...
        System.out.println("wcounter start");
...
//              System.out.println(wcounter);
  ...
  //            System.out.println(wcounter);
        ...
        System.out.println("wcounter end");

        System.out.println("w2counter start");
...
//            System.out.println(w2counter);
        ...
        System.out.println("w2counter end");

        System.out.println("ncounter start");
...
//          System.out.println(j);
        ...
        System.out.println("ncounter end");

        System.out.println("n2counter start");
    ...
    //        System.out.println(n2counter);
        ...
        System.out.println("n2counter end");

//        System.out.println("freq start");
...
//        }
        ...
        int cdcounter=0;
        for (int j = 0; j < tempdisp2; j++)    // cal the result of cond. prob.
          for (int i = 0; i < tempdisp; i++)
        ...
        if (sortflag == true)
        {
          for (int i = cdcounter; i > 1; --i) { // selection sorting cond. prob.
            int min = 0;
            for (int j = 1; j < i; ++j)
              if (cond[j] < cond[min])
                min = j;
