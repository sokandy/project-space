  ...
  public static void main(String args[])
  {
    try
    {
      ...
      if (f.exists())
      {
        ...
        String[] word = new String[fileSize]; // String array store a word
        String[] word2 = new String[fileSize];
        String[] wfreq = new String[fileSize];
        String[] w2freq = new String[fileSize];
        int[] freq = new int[fileSize];
        int[] freq2 = new int[fileSize];
        double[] cond = new double[fileSize];
        int[] brk = new int[fileSize];
