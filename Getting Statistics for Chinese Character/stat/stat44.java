  ...
  public static void main(String args[])
  {
    try
    {
      ...
      if (f.exists())
      {
        ...
        String[] word2 = new String[fileSize];
        String[] wfreq = new String[fileSize/2];
        String[] w2freq = new String[fileSize];
        int[] freq = new int[fileSize/2];
        int[] freq2 = new int[fileSize];
	...
	freq[wf]++;
        ...
        for (int n = 0; n < fileSize; n++)   // counting the freq. of two word
          freq2[n] = 0;
